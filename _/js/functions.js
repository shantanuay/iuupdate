...
if (scroll >= 20) {
$("header,.menu-header-top,.topbar, .section1").addClass("shrinkheader");
} else {
$("header,.menu-header-to, .topbar , .section1").removeClass("shrinkheader");
...
$('#want_to_volunteer').prev().fadeOut();
